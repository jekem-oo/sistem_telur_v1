...
export const SAMPLE_EGGS: EggInspectionData[] = [
  {
    ...
    imageUrl: '/assets/candling/IMG_0739.JPG',
    grade: 'Grade A',
    confidence: 98,
    ...
    notes: 'Dataset Grade A Sinar Merah Asli (IMG_0739.JPG)',
  ...
  },
  {
    ...
    imageUrl: '/assets/candling/IMG_0444.JPG',
    grade: 'Grade B',
    confidence: 94,
    size: 'Large (55-60g)',
    ...
    notes: 'Dataset Grade B Sinar Merah Asli (IMG_0444.JPG, Mutu II SNI)',
    isGroundTruthVerified: true,
  ...
  },
  {
    ...
    imageUrl: '/assets/candling/IMG_0567.JPG',
    grade: 'Grade C',
    confidence: 93,
    size: 'Medium (50-55g)',
    ...
    notes: 'Dataset Grade C Sinar Merah Asli (IMG_0567.JPG & IMG_0561.JPG)',
    isGroundTruthVerified: true,
    verifiedBy: 'Sistem Terkalibrasi',
    syncedToCloud: true,
    cloudSyncTimestamp: Date.now() - 1000 * 60 * 5,
  },
  {
    ...
    imageUrl: '/assets/candling/IMG_REJECT_CRACK.JPG',
    grade: 'Grade D',
    confidence: 99,
    size: 'Large (55-60g)',
    ...
    notes: 'Dataset Grade D Sinar Merah Asli (IMG_REJECT_CRACK.JPG - Aturan: Selain Grade A, B, C = Grade D)',
    isGroundTruthVerified: true,
  ...
  },
  {
    ...
    imageUrl: '/assets/candling/IMG_REJECT_BLOOD.JPG',
    grade: 'Grade D',
    confidence: 96,
    size: 'Medium (50-55g)',
    ...
    notes: 'Dataset Grade D Sinar Merah Asli (IMG_REJECT_BLOOD.JPG - Aturan: Selain Grade A, B, C = Grade D)',
    isGroundTruthVerified: true,
    verifiedBy: 'Inspector AI + Operator',
    syncedToCloud: false,
  },
